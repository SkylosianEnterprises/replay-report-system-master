...
store.prototype.window = function (window) {
	...
	if (this.debug) this.windowmap[window].on('insert', function ( event ) { 
...
storewindow.prototype.version = function (version) {
	...
	if (this.debug) this.versionmap[version].on('insert', function ( event ) { 
...
storeversion.prototype.list = function (key) {
	...
	if (this.debug) this.lists[key].on('insert', function ( event ) {
